...
#train_x, train_y = create_dataset(look_forward=10)
...
n_train_minutes = int(2*values.shape[0]/ 3)
...
# fit network
history = model.fit(train_X, train_y, nb_epoch=50, batch_size=72, validation_data=(test_X, test_y), verbose=2,
                    shuffle=False)
# plot history
